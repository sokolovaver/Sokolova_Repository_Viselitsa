/**
    @file GameAverageAnimals.cs
    @brief Файл окна игрового поля для среднего уровня категории животных
    @copyright Viselitsa
    @author Соколова В.А.
    @date 10-05-2024
    @version 1.1.20
\par Использует класс:
    @ref GameAverageAnimals
\par Содержит класс:
    @ref GameAverageAnimals
*/
using System;
...
{
    /**
    @brief Класс GameAverageAnimals
    ...
    */
    public partial class GameAverageAnimals : Form
    {
        ...
        */
        ...
        {
            string[] wordList = File.ReadAllLines("Животные ср.ур.txt");

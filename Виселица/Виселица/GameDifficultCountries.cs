/**
    @file GameDifficultCountries.cs
    @brief Файл окна игрового поля для сложного уровня категории стран
    @copyright Viselitsa
    @author Соколова В.А.
    @date 10-05-2024
    @version 1.1.20
\par Использует класс:
    @ref GameDifficultCountries
\par Содержит класс:
    @ref GameDifficultCountries
*/
using System;
...
{
    /**
    @brief Класс GameDifficultCountries
    ...
    public partial class GameDifficultCountries : Form
    {
       ...
       */
        ...
        */
        ...
        {
            string[] wordList = File.ReadAllLines("Страны сл.ур.txt");

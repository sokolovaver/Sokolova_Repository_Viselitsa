/**
    @file GameAverageCities.cs
    @brief Файл окна игрового поля для среднего уровня категории городов
    @copyright Viselitsa
    @author Соколова В.А.
    @date 10-05-2024
    @version 1.1.20
\par Использует класс:
    @ref GameAverageCities
\par Содержит класс:
    @ref GameAverageCities
*/
using System;
    ...
    */
    public partial class GameAverageCities : Form
    {
        ...
        */
        ...
        {
            string[] wordList = File.ReadAllLines("Города ср.ур.txt");/// Открытие текстового файла

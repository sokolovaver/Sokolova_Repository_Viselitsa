/**
    @file GameDifficultAnimals.cs
    @brief Файл окна игрового поля для сложного уровня категории животных
    @copyright Viselitsa
    @author Соколова В.А.
    @date 10-05-2024
    @version 1.1.20
\par Использует класс:
    @ref GameDifficultAnimals
\par Содержит класс:
    @ref GameDifficultAnimals
*/
using System;
...
{
    /**
    @brief Класс GameDifficultAnimals

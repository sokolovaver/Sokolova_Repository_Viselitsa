/**
    @file GameLightCities.cs
    @brief Файл окна игрового поля для лёгкого уровня категории городов
    @copyright Viselitsa
    @author Соколова В.А.
    @date 10-05-2024
    @version 1.1.20
...
namespace Виселица
{
    ...
    */
    public partial class GameLightCities : Form
    {
        ...
        */
        private void GameLightCities_Load(object sender, EventArgs e)
        {
        ...
        */
        ...
        {
            string[] wordList = File.ReadAllLines("Города.txt");/// Открытие текстового файла
